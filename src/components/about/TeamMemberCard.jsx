  ...
  return (
    <article className="grid gap-6 lg:grid-cols-2 items-start rounded-md border border-[var(--border)] bg-[var(--surface)] p-6">
      ...
      <div className="space-y-4">
        <div>
          <div className="inline-block rounded-full bg-[var(--accent)]/90 px-3 py-1 text-xs font-ui font-semibold text-[var(--bg)]">{role}</div>
        </div>
        ...
        {quote && (
          <blockquote className="mt-2 border-l-2 border-[var(--accent)] pl-4 italic text-[var(--muted)]">“{quote}”</blockquote>
        )}
